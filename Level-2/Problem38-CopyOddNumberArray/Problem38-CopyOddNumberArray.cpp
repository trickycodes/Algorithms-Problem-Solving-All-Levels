...
{
	return  number % 2 == 1 ? enOddOrEven::Odd : enOddOrEven::Even;
}
...
void CopyOddNumsWithAddArrayElements(int arrSrc[100], const int& arrSrcLen, int arrDest[100], int& arrDestLen)
{
	for (int i = 0; i < arrSrcLen; i++)
		if(OddOrEven(arrSrc[i]) == enOddOrEven::Odd)
...
int main()
{
	...
	CopyOddNumsWithAddArrayElements(arraySource, arraySourceLen, arrayDest, arrayDestLen);
